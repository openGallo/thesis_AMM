"""
Download Binance historical spot aggregate trades from data.binance.vision.

This script can be run directly, but the recommended entry point is:
    python main_import_cex.py

Direct example:
    python fetch_binance_agg_trades.py --symbols ETHUSDC --start 2024-01-01 --end 2024-01-02 --granularity daily
"""
...
def download_binance_agg_trades(
    ...
    for symbol in symbols:
        ...
        for period in periods:
            print(f"[aggTrades] {symbol} {granularity} {period}")
