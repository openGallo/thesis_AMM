"""
Uniswap V3 USDC/WETH 0.01% — Pool Time-Series Downloader
=========================================================
...
Fetches from The Graph:
    ...
    data_raw/multitier/fee_100/bundle_current.csv

Pool:      USDC/WETH 0.01%  (fee tier 100)
...
Setup:
    ...
    py -3 scripts/import_data/DEX/fetch_uniswap_pool_001pct_timeseries.py
"""
...
POOL     = "0xe0554a476a092703abdb3ef35c80e0d76d32939f"   # USDC/WETH 0.01%
FEE_TIER = 100
FEE_RATE = 0.0001
...
def main() -> None:
    ...
    data_dir     = project_root / "data_raw" / "multitier" / "fee_100"
    data_dir.mkdir(parents=True, exist_ok=True)

    print("=" * 70)
    print(f"Uniswap V3 USDC/WETH 0.01%%  (fee tier {FEE_TIER})  —  Pool Time Series")
    print(f"Pool: {POOL}")
    print("=" * 70)
