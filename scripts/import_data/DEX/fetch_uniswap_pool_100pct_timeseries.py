"""
Uniswap V3 USDC/WETH 1.00% — Pool Time-Series Downloader
=========================================================
...
Fetches from The Graph:
    ...
    data_raw/multitier/fee_10000/bundle_current.csv

Pool:      USDC/WETH 1.00%  (fee tier 10000)
...
Setup:
    ...
    py -3 scripts/import_data/DEX/fetch_uniswap_pool_100pct_timeseries.py
"""
...
POOL     = "0x7bea39867e4169dbe237d55c8242a8f2fcdcc387"   # USDC/WETH 1.00%
FEE_TIER = 10000
FEE_RATE = 0.01
...
def main() -> None:
    ...
    data_dir     = project_root / "data_raw" / "multitier" / "fee_10000"
    data_dir.mkdir(parents=True, exist_ok=True)

    print("=" * 70)
    print(f"Uniswap V3 USDC/WETH 1.00%  (fee tier {FEE_TIER})  —  Pool Time Series")
    print(f"Pool: {POOL}")
    print("=" * 70)
